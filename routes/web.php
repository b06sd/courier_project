...
Route::group(['middleware' => ['auth', 'permission_clearance']], function() {
    ...
    Route::get('transactions/{consignee}', 'ConsigneeController@transactions')->name('transactions');
    ...
    Route::get('allCouriers', 'CourierController@allCouriers')->name('allCouriers');
