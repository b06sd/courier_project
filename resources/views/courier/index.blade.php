              ...
              <div id="courier-modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
              <form method="post" action="/courier" id="edit_courier_form">
                {{ method_field('PATCH') }}
                @csrf
                <div class="modal fade" id="courier-modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Edit Courier
                        <button type="button" class="close" style="padding: 0.5rem;" data-dismiss="modal" aria-hidden="true">x</button>
                      </h5>
                      </div>
                      <div class="modal-body">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <button class="btn btn-primary" type="submit" id="pharm_btn">Update</button>
                      </div>
                    </div>
                  </div>
                      </div>
